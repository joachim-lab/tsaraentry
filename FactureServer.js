 ...
 */
function factPdfPrbBody(orderNumber) {
...
/* TEMPORARY TIMING PROBE (2026-09-15) — see the end of CommandesServer.js.
 * Remove by restoring this file from _parked/pull/tsaraentry_20260915-2347/. */
function factPdf(orderNumber) {
  var own = prbStart("factPdf", "order=" + orderNumber);
  try { return factPdfPrbBody(orderNumber); }
  finally { prbEnd(own); }
}
